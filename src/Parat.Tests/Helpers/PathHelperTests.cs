...
public class PathHelperTests : IDisposable
{
    ...
    {
        _tempDir = Path.Combine(Path.GetTempPath(), $"parat_path_test_{Guid.NewGuid():N}");
    ...
    /// directory (%LOCALAPPDATA%\PARAT), NOT under the exe/repo root.
